    ...
    if (errorCode != EGL_SUCCESS)
    {
        ...
        switch (errorCode)
        {
            ...
            case EGL_BAD_CURRENT_SURFACE : {
                ...
                description =
                    "the current surface of the calling thread is a window, pbuffer, or pixmap that is no longer "
                    "valid";
                break;
            }
            ...
            case EGL_BAD_SURFACE : {
                ...
                description =
                    "an EGLSurface argument does not name a valid surface (window, pbuffer, or pixmap) configured "
                    "for rendering";
                break;
            }
            ...
            case EGL_BAD_MATCH : {
                error = "EGL_BAD_MATCH";
                description =
                    "arguments are inconsistent; for example, an otherwise valid context requires buffers (e.g. "
                    "depth or stencil) not allocated by an otherwise valid surface";
                break;
            }
